...
(function() {
  $(function() {
    return $(document).on('click', 'form.edit_dish .remove_fields ', function(event) {
...
(function() {
  jQuery(function() {
    var categories, setCategoryMenu;
    ...
    setCategoryMenu = function() {
      ...
      if (options) {
        ...
        return $('#dish_category_id').parent().show();
      } else {
        $('#dish_category_id').empty();
        return $('#dish_category_id').parent().hide();
      }
    };
    $('#dish_menu_id').change(setCategoryMenu);
    setCategoryMenu();
    $('form').on('click', '.remove_ingredients', function(event) {
      $(this).prev('input[type=hidden]').val('1');
      $(this).closest('fieldset').hide();
      return event.preventDefault();
    });
    return $('form').on('click', '.add_fields', function(event) {
      ...
      $(this).prev('.row').append($(this).data('fields').replace(regexp, time));
      return event.preventDefault();
    });
  });
