class RestaurantsController < ApplicationController
  ...
  private
    ...
    def restaurant_params
      params.require(:restaurant).permit(:name, :address_1, :address_2, :city, :state, :zipcode, :description, :phone, :dollars, :reservations, :hide, :avatar)
    end
end
